...
!function (def) {
	...
	Runner.prototype.getContext = function () {
		if (this._context) {
			...
			// context is not set, so give a global scope :)
			return (function () {
				return this;
			})();
		}
	 ...
	 */
	Runner.prototype.series = function () {
		this._mode = 'series';
	 ...
	 */
	Runner.prototype.waterfall = function () {
	 ...
	 */
	Runner.prototype.mode = function () {
		return this._mode;
	};
